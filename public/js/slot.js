...
for(i=0;i<count;i++)
{
    ...
    var number=$('#number').val();
	 ...
	 var age=$('#age').val();
	  if(number==''){
	 	$('#numerror').text('please Enter number');
	  }else{
	  if(!$("#terms").prop("checked"))
    {
        $("#termserror").text('accepts terms and conditions');
    }
    else
    {
    	 if(!$("#age").prop("checked"))
    {
        $("#ageerror").text(' please confirm that you are over the age 18');
    }
    else
    {
	  $.ajax({
  ...
  function() 
  {
	...
	$('#text').html('<p class="text-white"><b>“ you still stand a change to win these amazing gift cards “</b></p>\
   		...
   		<div class="row">\
   			<div class="col-md-4">\
   				<img src="https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/phones/mate40/images/intro/kv/3-o@2x.webp" width="100" height="100">\
   			</div>\
   			<div class="col-md-4">\
   				<img src="https://consumer.huawei.com/content/dam/huawei-cbg-site/common/mkt/pdp/phones/mate40/images/intro/kv/3-o@2x.webp" width="100" height="100">\
   			</div>\
